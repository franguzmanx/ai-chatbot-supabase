...
export function CustomLogo({ size = 14 }: { size?: number }) {
  return (
    <svg 
      width={size} 
      height={size * (429/455)} 
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clipPath="url(#clip0_153_20)">
        <path d="M173.37 371.532H227.529L53.9242 0H0M455 0H401.076L227.529 371.532H281.689M227.529 371.532L200.803 429H254.256L254.315 428.942L227.529 371.532ZM254.845 260.323L254.786 260.265H200.567L227.706 318.606L254.845 260.323Z" fill="currentColor"/>
      </g>
      <defs>
        <clipPath id="clip0_153_20">
          <rect width="455" height="429" fill="white"/>
        </clipPath>
      </defs>
    </svg>
  );
